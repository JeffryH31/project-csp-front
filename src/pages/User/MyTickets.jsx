  ...
  return (
    ...
    >
      ...
      <div>
        ...
        <p>
          <strong>Bioskop:</strong> {ticket.cinema_name} -{" "}
          {ticket.cinema_location}
        </p>
        <p>
          <strong>Jadwal:</strong>{" "}
          {new Date(ticket.show_date).toLocaleDateString("id-ID", {
            weekday: "long",
            year: "numeric",
            month: "long",
            day: "numeric",
        ...
        <p>
          <strong>Nomor Kursi:</strong> {ticket.seat_number}
        </p>
        <p>
          <small>
            Dipesan pada:{" "}
            {new Date(ticket.booking_date).toLocaleString("id-ID")}
          </small>
        </p>
      </div>
    </div>
